...
public class DatabaseServiceImpl implements DatabaseService {
    ...
    @Autowired
    DatabaseServiceImpl(EntityManager em, Connection connection, Logger logger) {
    ...
    public Student getStudentFromDatabase(String studentFullName) {
        ...
        try {
            return em.createQuery(
                            "SELECT s FROM Student s WHERE s.firstName = :firstName AND s.familyName = :familyName AND s.patronicName = :surName",
                            Student.class)
